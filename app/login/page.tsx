    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: "#F8F4D8" }}>
      <Card className="w-full max-w-md p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Access your CryptoForGigs account</p>
          <p className="text-xs text-blue-600 mt-3 p-2 bg-blue-50 rounded">Demo Mode: Use any email/password</p>
        </div>
